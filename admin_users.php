...
<div class="sidebar" id="sidebar">
    ...
    <div class="nav flex-column mt-3">
        ...
        <a href="admin_users.php" class="nav-link active"><span class="material-symbols-outlined">people</span> Kelola Pengguna</a>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="admin_reset_pw.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning" onclick="return confirm('Reset password?')">Reset</a>
                                <a href="user_hapus.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Hapus?')">Hapus</a>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
